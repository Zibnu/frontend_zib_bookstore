...
function CheckoutStepBar({ currentStep}) {
  return (
    <div className='flex items-center gap-4 mb-8'>
      <div className={`flex items-center gap-2 ${currentStep === "shipping" ? "text-blue-600" : "text-gray-400"}`}>
      ...
      <div className={`flex items-center gap-2 ${currentStep === "payment" ? "text-blue-600" : "text-gray-300"}`}>
        <div className="w-8 h-8 flex items-center justify-center border rounded-full font-medium">
          2
        </div>
